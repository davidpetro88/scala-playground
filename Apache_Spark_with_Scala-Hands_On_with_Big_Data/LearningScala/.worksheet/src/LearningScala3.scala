object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(432); 
  ...
  };System.out.println("""transformToUpperCase: (x: String)String""");$skip(44); 
  
  println(transformToUpperCase("david"));$skip(53); 
    
  println(transformToUpperCase("david abraao"));$skip(62); 
  
  println(transformToUpperCase("david abraao" + " petro"))}
}
